                ...
                <div class="flex-auto px-0 pt-2 pb-2">
                    <div class="p-4 max-w-xl mx-auto">
                        <form action="{{ route('locations.store') }}" method="POST" class="space-y-4">
                            ...
                            <!-- Name -->
                            <div>
                                <label for="location-name" class="block text-sm font-medium text-slate-700">Location Name <span class="text-red-500">*</span></label>
                                <input type="text" id="location-name" name="name"
                                    ...
                                    placeholder="e.g., TULT-06-01" required>
                            </div>

                            <!-- Description -->
                            <div>
                                <label for="location-description" class="block text-sm font-medium text-slate-700">Description</label>
                                <textarea id="location-description" name="description" rows="1"
                                    class="mt-1 block w-full rounded-lg border border-slate-200 shadow-sm focus:ring-2 focus:ring-yellow-500 focus:outline-none px-3 py-2 text-sm text-slate-800"
