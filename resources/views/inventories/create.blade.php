            ...
            <div class="relative flex flex-col min-w-0 mb-6 mt-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded bg-clip-border">
                <div class="p-6 pb-2 mb-0 bg-gradient-to-r from-blue-700 to-yellow-400 border-b-0 border-b-solid rounded border-b-transparent flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <h6 class="text-lg font-semibold text-white">Inventory</h6>
                    </div>
                </div>
                ...
                <div class="flex-auto px-0 pt-2 pb-2">
                    <div class="p-4 max-w-xl mx-auto">
                        <form action="{{ route('inventories.store') }}" method="POST" class="space-y-4">
                            ...
                            <!-- Computer Form -->
                            @include('inventories.partials.create-form-computer')

                            <!-- Drive Drive Form) -->
                            @include('inventories.partials.create-form-drives')

                            <!-- Processor Form -->
                            @include('inventories.partials.create-form-processors')

                            <!-- VGA Form -->
                            @include('inventories.partials.create-form-vga')

                            <!-- RAM Form -->
                            @include('inventories.partials.create-form-ram')

                            <!-- Monitor Form -->
                            @include('inventories.partials.create-form-monitors')

                            <!-- Other Items Form -->
                            @include('inventories.partials.create-form-others')
