<div id="processor-form" class="form-section">
    ...
    <div class="flex gap-x-6 mb-4">
        ...
        <div class="w-1/2 px-1">
            ...
            <div class="flex mt-1">
                <input type="number" step="0.1" min="0" id="processor-frequency" name="frequency"
                    value="{{ old('frequency', $inventory->frequency) }}"
        ...
        <div class="w-1/2 px-1">
            ...
            <input type="number" id="processor-stock" name="stock" min="0" step="1"
